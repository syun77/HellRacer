...
// ボタン画像
@:bitmap("assets/images/ui/button3.png")
private class GraphicButton extends BitmapData {}

/**
 * A simple button class that calls a function when clicked by the mouse.
 */
class MyFlxButton extends FlxTypedButton<FlxText>
{
  /**
  ...
  {
    super(X, Y, OnClick);
    loadGraphic(GraphicButton, true, 160, 20);
  ...
  {
    label = new FlxText(x + labelOffsets[NORMAL].x, y + labelOffsets[NORMAL].y, 160, Text);
