...
class SpikeUtil {
  ...
  static inline var CHIP_ROLL_LEFT:Int  = 9; // 回転(左回り)
  static inline var CHIP_ROLL_RIGHT:Int = 10; // 回転(右回り)
  ...
  public static function toSpikeType(id:Int):SpikeType {
    switch(id) {
      ...
      case CHIP_ROLL_LEFT:  return SpikeType.Roll(Dir.Left);
      case CHIP_ROLL_RIGHT: return SpikeType.Roll(Dir.Right);
      default:
